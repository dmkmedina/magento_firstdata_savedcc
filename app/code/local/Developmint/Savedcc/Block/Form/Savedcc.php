...
class Developmint_Savedcc_Block_Form_Savedcc extends Mage_Payment_Block_Form
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/form/savedcc.phtml');
    ...
    public function getSavedCreditCards() {
        ...
        if ($customer_id) {
            $saved_ccs = Mage::getModel('savedcc/savedcreditcards')
                ->getCollection()
